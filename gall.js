$(document).ready(function(){
	...
	if($(window).width() < 1025){
		$("#a1").click(function(){
			$("#1").css({transform: "rotate(-90deg) translate(0vh,-100vw)",display:"flex"});
			$("#1").animate({opacity:"1"});
		...
		$("#a2").click(function(){
			$("#2").css({transform: "rotate(-90deg) translate(0vh,-100vw)",display:"flex"});
			$("#2").animate({opacity:"1"});
			$("back").css("display","block");
			$("next").css("display","block");
		});
		...
		$("back").click(function(){$("box").animate({scrollTop:"-=210"},"slow");});
		$("next").click(function(){$("box").animate({scrollTop:"+=210"},"slow");});
